...
class TestsController extends \TCG\Voyager\Http\Controllers\VoyagerBaseController
{
    ...
    public function index(Request $request)
    {
        ...
        if (strlen($dataType->model_name) != 0) {
            ...
            if ($orderBy && in_array($orderBy, $dataType->fields())) {
               ...
               /* foreach ($dataTypeContent as $key) {
                    # code...
                    $b=$key->questions;
    ...
    {//$course=new Course();
        ...
        $dataType = Voyager::model('DataType')->where('slug', '=', $slug)->first();
       // dd($dataType->addRows[5]->details->model);
        // Check permission
